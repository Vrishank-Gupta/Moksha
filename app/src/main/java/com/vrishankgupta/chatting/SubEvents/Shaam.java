...
public class Shaam extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.shaam_details);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AuthUI.getInstance().signOut(Shaam.this).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
