...
public class ActTillYouClimax extends AppCompatActivity {

    Button regButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.act_till_details);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AuthUI.getInstance().signOut(ActTillYouClimax.this).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
