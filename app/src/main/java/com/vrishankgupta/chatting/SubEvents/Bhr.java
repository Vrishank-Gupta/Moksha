...
public class Bhr extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bhr_details);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AuthUI.getInstance().signOut(Bhr.this).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
